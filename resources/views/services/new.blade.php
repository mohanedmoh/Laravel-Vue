...
<td>
<a href="{{route('services_edit', Crypt::encrypt($obj->id))}}" data-toggle="tooltip" data-placement="top" title="Edit  Data" class="btn btn-warning" ><span class="fa fa-edit fa-fw"></span></a>                                                        
...
<hr/>
  <div class="portlet box red">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="{{url('/services_new')}}" method="POST" class="form-horizontal">
                                                   <div class="form-body">
                                                   {{ csrf_field() }}
                                                        ...
                                                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <textarea rows="4" cols="50"  class="form-control input-circle-right" name="description" id="description" value="{{old('description')}}"  required>{{old('description')}} </textarea>
