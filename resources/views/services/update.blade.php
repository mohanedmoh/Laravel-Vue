...
<br/>
 ...
 <div class="portlet box red">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="{{url('/services_update')}}" method="POST" class="form-horizontal">
                                                   <div class="form-body">
                                                   {{ csrf_field() }}
                                                        ...
                                                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <textarea rows="4" cols="50"  class="form-control input-circle-right" name="description" id="description" value="{{old('description',$objs->description)}}"  required>{{old('description',$objs->description)}}</textarea>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-7 col-md-4">
                                                                ...
                                                                <a href="{{route('services')}}"  class="btn btn-circle grey-salsa btn-outline">Back</a>
